...
for (let index = 0; index < classes.length; index++) {
    ...
    element.addEventListener("click",(e)=>{
        ...
        if (click_switch==0) {
            ...
            feature.children[1].style.cssText="color:black;bottom:calc(60vh - 6vw - 4px);background: linear-gradient(300deg,cyan,white);background-size: 120% 120%;animation: gradient-animation 2s ease infinite";
